...
Subscriberの生成時にも、上記のように設定した `rclcpp::QoS` クラスを与えることでQoSを指定できる。（参考： [rclcpp::Node::create\_subscription](https://github.com/ros2/rclcpp/blob/humble/rclcpp/include/rclcpp/node.hpp#L219) ）
